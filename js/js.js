...
function updateCountdown2() {
  ...
  document.getElementById("day2").innerText = Math.floor(
    difference / (1000 * 60 * 60 * 24)
  );
  document.getElementById("hour2").innerText = Math.floor(
    (difference % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60)
  );
  document.getElementById("minute2").innerText = Math.floor(
    (difference % (1000 * 60 * 60)) / (1000 * 60)
  );
  document.getElementById("second2").innerText = Math.floor(
    (difference % (1000 * 60)) / 1000
  );
...
function mute() {
  ...
  if (!isMute) {
    ...
    audio.pause();
    button.innerHTML =
      '<i color="#000" class="fa fa-volume-off my-float"><br><br> click here to play song </i>';
    ...
    audio.play();
    button.innerHTML =
      '<i color="#fff" class="fa fa-volume-up my-float"><br><br> Enjoy </i>';
